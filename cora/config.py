...
class CoraConfig(_FileConfigMixin, _RetrieverConfigMixin):
    ...
    def keyword_index_cache_directory(cls) -> Path:
        keyword_index_cache_directory = CoraConfig.cache_directory() / "keyword_indices"
